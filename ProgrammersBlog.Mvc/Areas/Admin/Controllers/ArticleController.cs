...
namespace ProgrammersBlog.Mvc.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        public ArticleController(IArticleService articleService, ICategoryService categoryService, UserManager<User> userManager, IMapper mapper, IImageHelper imageHelper, IToastNotification toastNotification) : base(userManager, imageHelper, mapper)
        {
