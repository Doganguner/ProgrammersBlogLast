...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class CategoryController : BaseController
    {
        ...
        public CategoryController(ICategoryService categoryService, UserManager<User> userManager, IMapper mapper, IImageHelper imageHelper) : base(userManager, imageHelper, mapper)
        {
