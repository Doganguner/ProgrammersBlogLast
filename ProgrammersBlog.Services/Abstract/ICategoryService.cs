...
namespace ProgrammersBlog.Services.Abstract
{
    public interface ICategoryService
    {
        ...
        /// </summary>
        /// <param name="categoryAddDto">categoryAddDto tipinde eklenecek kullanıcı adı</param>
        /// <param name="createdByName">string tipinde kullanıcı adı</param>
        /// <returns>Asekron bir operasyon ile Task olarak bizlere ekleme işleminin sonucunu DataResult tipinde döner.</returns>
